...
// TWI instance.
static const nrf_drv_twi_t m_twi_adx372 = NRF_DRV_TWI_INSTANCE(TWI_INSTANCE_ID);
// I2C pins
#define ADXL372_I2C_SA0_PIN    12
#define ADXL372_I2C_SDA_PIN    25
#define ADXL372_I2C_SCL_PIN    22
#define ADXL372_I2C_SS_PIN     11
...
//// SPI instance.
//static const nrf_drv_spi_t m_spi_adx372 = NRF_DRV_SPI_INSTANCE(SPI_INSTANCE_ID);
//// SPI pins
//#define ADXL372_SPI_MISO_PIN     5
//#define ADXL372_SPI_MOSI_PIN     4
//#define ADXL372_SPI_SCK_PIN     26
//#define ADXL372_SPI_SS_PIN      27
...
extern void     ADXL372_Read_Accel_Data(int16_t *x, int16_t *y, int16_t *z);
